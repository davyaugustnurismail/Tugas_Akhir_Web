                                        ...
                                        <div class="card card-transparent card-block card-stretch event-note">
                                            <div class="card-body px-0 bukmark">
                                                ...
                                                <div id="quill-toolbar">
                                                    ...
                                                    <img src="{{url('../assets/images/event-note/01.png')}}" class="img-fluid image-1" alt="image">                                                    
                                                    <img src="{{url('../assets/images/event-note/02.png')}}" class="img-fluid image-2" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>                                    
                                ...
                                <div class="card card-block card-stretch card-height card-bottom-border-primary note-detail">
                                    ...
                                    <div class="card-body rounded">
                                        ...
                                        <ul class="row mb-0 p-0 list-inline flex-wrap align-items-center">
                                            <li class="col-md-4">
                                                <a href="#">
                                                    <img src="{{url('../assets/images/gallery/grid/01.jpg')}}" class="img-fluid rounded note-image" alt="" />  
                                                </a> 
                                            </li>
                                            <li class="col-md-4">
                                                <a href="#">
                                                    <img src="{{url('../assets/images/gallery/grid/02.jpg')}}" class="img-fluid rounded note-image" alt="" />  
                                                </a> 
                                            </li>
                                            <li class="col-md-4">
                                                <a href="#">
                                                    <img src="{{url('../assets/images/gallery/grid/03.jpg')}}" class="img-fluid rounded note-image" alt="" />  
                                                </a> 
                                            </li>
                                        </ul>
                                    </div>

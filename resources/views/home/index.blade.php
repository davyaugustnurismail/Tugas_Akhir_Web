                                    ...
                                    <div class="p-3">
                                            ...
                                            <div class="media align-items-center cust-card pb-3 border-bottom">
                                                <div class="">
                                                    <img class="avatar-50 rounded-small"
                                                        src="{{url('images/user/01.jpg')}}" alt="01">
                                                </div>
                                        ...
                                        <a href="#" class="iq-sub-card">
                                            <div class="media align-items-center cust-card py-3 border-bottom">
                                                <div class="">
                                                    <img class="avatar-50 rounded-small"
                                                        src="{{url('images/user/02.jpg')}}" alt="02">
                                                </div>
                                                <div class="media-body ml-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="#" class="iq-sub-card">
                                            <div class="media align-items-center cust-card pt-3">
                                                <div class="">
                                                    <img class="avatar-50 rounded-small"
                                                        src="{{url('images/user/03.jpg')}}" alt="03">
                                                </div>
                                                <div class="media-body ml-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card card-transparent card-block card-stretch event-note">
                                        <div class="card-body px-0 bukmark">
                                            ...
                                            <div id="quill-toolbar">
                                                ...
                                                <img src="{{url('images/event-note/01.png')}}" class="img-fluid image-1"
                                                    alt="image">
                                                <img src="{{url('images/event-note/02.png')}}" class="img-fluid image-2"
                                                    alt="image">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12 p-0 d-flex justify-content-end">
                                    ...
                                    <button class="btn btn-primary ml-2" data-extra-toggle="toggle"
                                        data-extra-class-show=".show-note-button"
                                        data-extra-class-hide=".hide-note-button">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="d-flex nav nav-pills text-center note-tab mb-3" id="note-pills-tab"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link home" data-toggle="pill" data-init="pin-note" href="#note3"
                                        role="tab" aria-selected="false">Pin Notes</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link home" data-toggle="pill" data-init="fav-note" href="#note4"
                                        role="tab" aria-selected="false">Favourite Notes</a>
                                </li>
                            </ul>
                                                ...
                                                <div class="card-header d-flex justify-content-between pb-1">
                                                    ...
                                                    <div class="card-header-toolbar d-flex align-items-center">
                                                        <a href="#" data-toggle="tooltip" data-placement="top" title=""
                                                            class="show-tab" data-show-tab="[href='#note4']"
                                                            data-original-title="favorite"><i
                                                                class="lar la-heart mr-2"></i></a>
                                                        <div class="card-header-toolbar d-flex align-items-center">
                                                            <div class="dropdown">
                                                                <span class="dropdown-toggle dropdown-bg"
                                                                    id="note-dropdownMenuButton6" data-toggle="dropdown"
                                                                    aria-expanded="false" role="button">
                                                                    <i class="ri-more-fill"></i>
                                                                </span>
                                                                <div class="dropdown-menu dropdown-menu-right"
                                                                    aria-labelledby="note-dropdownMenuButton6" style="">
                                                                    <a href="#" class="dropdown-item new-note3"
                                                                        data-toggle="modal" data-target="#new-note3"><i
                                                                            class="las la-eye mr-3"></i>View</a>
                                                                    <a href="#" class="dropdown-item edit-note1"
                                                                        data-toggle="modal" data-target="#edit-note1"><i
                                                                            class="las la-pen mr-3"></i>Edit</a>
                                                ...
                                                <div class="card-footer">
                                                    <div
                                                        ...
                                                        <a href="#" class=""><i
                                                                class="las la-user mr-2 font-size-20"></i>Only You</a>
                                                        <a href="#" class=""><i
                                                                class="las la-calendar mr-2 font-size-20"></i>09 Jan
                                                            2021</a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-header d-flex justify-content-between pb-1">
                                                    ...
                                                    <div class="card-header-toolbar d-flex align-items-center">
                                                        ...
                                                        <div class="card-header-toolbar d-flex align-items-center">
                                                            <div class="dropdown">
                                                                <span class="dropdown-toggle dropdown-bg"
                                                                    id="note-dropdownMenuButton7" data-toggle="dropdown"
                                                                    aria-expanded="false" role="button">
                                                                    <i class="ri-more-fill"></i>
                                                                </span>
                                                                <div class="dropdown-menu dropdown-menu-right"
                                                                    aria-labelledby="note-dropdownMenuButton7" style="">
                                                                    <a href="#" class="dropdown-item new-note4"
                                                                        data-toggle="modal" data-target="#new-note4"><i
                                                                            class="las la-eye mr-3"></i>View</a>
                                                                    <a href="#" class="dropdown-item edit-note1"
                                                                        data-toggle="modal" data-target="#edit-note1"><i
                                                                            class="las la-pen mr-3"></i>Edit</a>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div
                                                ...
                                                <div class="card-header d-flex justify-content-between pb-1">
                                                    ...
                                                    <div class="card-header-toolbar d-flex align-items-center">
                                                        <a href="#" data-toggle="tooltip" data-placement="top" title=""
                                                            class="show-tab" data-show-tab="[href='#note3']"
                                                            data-original-title="pin content"><i
                                                                class="las la-thumbtack mr-2"></i></a>
                                                        <div class="card-header-toolbar d-flex align-items-center">
                                                            <div class="dropdown">
                                                                <span class="dropdown-toggle dropdown-bg"
                                                                    id="note-dropdownMenuButton8" data-toggle="dropdown"
                                                                    aria-expanded="false" role="button">
                                                                    <i class="ri-more-fill"></i>
                                                                </span>
                                                                <div class="dropdown-menu dropdown-menu-right"
                                                                    aria-labelledby="note-dropdownMenuButton8" style="">
                                                                    <a href="#" class="dropdown-item new-note5"
                                                                        data-toggle="modal" data-target="#new-note5"><i
                                                                            class="las la-eye mr-3"></i>View</a>
                                                                    <a href="#" class="dropdown-item edit-note1"
                                                                        data-toggle="modal" data-target="#edit-note1"><i
                                                                            class="las la-pen mr-3"></i>Edit</a>
                                                ...
                                                <div class="card-body rounded">
                                                    ...
                                                    <ul class="row mb-0 p-0 list-inline flex-wrap align-items-center">
                                                        <li class="col-4">
                                                            <a href="#">
                                                                <img src="{{url('images/gallery/grid/08.jpg')}}"
                                                                    class="img-fluid note-image rounded" alt="" />
                                                            </a>
                                                        </li>
                                                        <li class="col-4">
                                                            <a href="#">
                                                                <img src="{{url('images/gallery/grid/05.jpg')}}"
                                                                    class="img-fluid note-image rounded" alt="" />
                                                            </a>
                                                        </li>
                                                        <li class="col-4">
                                                            <a href="#">
                                                                <img src="{{url('images/gallery/grid/03.jpg')}}"
                                                                    class="img-fluid note-image rounded" alt="" />
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div class="card-footer">
                                                    <div
                                                        ...
                                                        <a href="#" class=""><i
                                                                class="las la-user-friends mr-2 font-size-20"></i>01
                                                            Share</a>
                                                        <a href="#" class=""><i
                                                                class="las la-calendar mr-2 font-size-20"></i>05 Jan
                                                            2021</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div class="card-header d-flex justify-content-between pb-1">
                                                    ...
                                                    <div class="card-header-toolbar d-flex align-items-center">
                                                        <div class="dropdown">
                                                            <span class="dropdown-toggle dropdown-bg"
                                                                id="note-dropdownMenuButton9" data-toggle="dropdown"
                                                                aria-expanded="false" role="button">
                                                                <i class="ri-more-fill"></i>
                                                            </span>
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        <div class="card-header-toolbar d-flex align-items-center">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right"
                                                                    ...
                                                                    style="">
                                                                    <a href="#" class="dropdown-item new-note7"
                                                                        data-toggle="modal" data-target="#new-note7"><i
                                                                            class="las la-eye mr-3"></i>View</a>
                                                                    <a href="#" class="dropdown-item edit-note1"
                                                                        data-toggle="modal" data-target="#edit-note1"><i
                                                                            class="las la-pen mr-3"></i>Edit</a>
                                                ...
                                                <div class="card-footer">
                                                    <div
                                                        ...
                                                        <a href="#" class=""><i
                                                                class="las la-user mr-2 font-size-20"></i>Only You</a>
                                                        <a href="#" class=""><i
                                                                class="las la-calendar mr-2 font-size-20"></i>11 Jan
                                                            2021</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div class="card-header d-flex justify-content-between pb-1">
                                                    ...
                                                    <div class="card-header-toolbar d-flex align-items-center">
                                                        <div class="dropdown">
                                                            <span class="dropdown-toggle dropdown-bg"
                                                                id="note-dropdownMenuButton11" data-toggle="dropdown"
                                                                aria-expanded="false" role="button">
                                                                <i class="ri-more-fill"></i>
                                                            </span>
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                ...
                                                <div class="card-footer">
                                                    <div
                                                        ...
                                                        <a href="#" class=""><i
                                                            ...
                                                            share</a>
                                                        <a href="#" class=""><i
                                                                class="las la-calendar mr-2 font-size-20"></i>13 Jan
                                                            2021</a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-footer">
                                                    <div
                                                        ...
                                                        <a href="#" class=""><i
                                                                class="las la-user mr-2 font-size-20"></i>Only You</a>
                                                        <a href="#" class=""><i
                                                                class="las la-calendar mr-2 font-size-20"></i>14 Jan
                                                            2021</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table  tbl-server-info">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h4 class="mb-2">Image Notes<i
                                                                        class="las la-thumbtack ml-2"></i></h4>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h4 class="mb-2">NotePlus for Entrepreneurs <i
                                                                        class="lar la-heart ml-2 show-tab"
                                                                        data-show-tab="[href='#note4']"></i></h4>
                                            ...
                                            <div
                                                ...
                                                <div class="card-footer">
                                                    <div
                                                        class="d-flex align-items-center justify-content-between note-text note-text-danger">
                                                        <a href="#" class=""><i
                                                                class="las la-user-friends mr-2 font-size-20"></i>05
                                                            share</a>
                                                        <a href="#" class=""><i
                                                                class="las la-calendar mr-2 font-size-20"></i>09 Jan
                                                            2021</a>
                                            ...
                                            <div
                                                ...
                                                <div class="card-body rounded">
                                                    ...
                                                    <ul class="row mb-0 p-0 list-inline flex-wrap align-items-center">
                                                        <li class="col-4">
                                                            <a href="#">
                                                                <img src="{{url('images/gallery/grid/01.jpg')}}"
                                                                    class="img-fluid rounded" alt="" />
                                                            </a>
                                                        </li>
                                                        <li class="col-4">
                                                            <a href="#">
                                                                <img src="{{url('images/gallery/grid/02.jpg')}}"
                                                                    class="img-fluid rounded" alt="" />
                                                            </a>
                                                        </li>
                                                        <li class="col-4">
                                                ...
                                                <div class="card-footer">
                                                    <div
                                                        ...
                                                        <a href="#" class=""><i
                                                                class="las la-user mr-2 font-size-20"></i>Only You</a>
                                                        <a href="#" class=""><i
                                                                class="las la-calendar mr-2 font-size-20"></i>9 Jan
                                                            2021</a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-footer">
                                                    <div
                                                        ...
                                                        <a href="#" class=""><i
                                                                class="las la-user mr-2 font-size-20"></i>Only You</a>
                                                        <a href="#" class=""><i
                                                                class="las la-calendar mr-2 font-size-20"></i>15 Jan
                                                            2021</a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-footer">
                                                    <div
                                                        ...
                                                        <a href="#" class=""><i
                                                                class="las la-user mr-2 font-size-20"></i>Only You</a>
                                                        <a href="#" class=""><i
                                                                class="las la-calendar mr-2 font-size-20"></i>18 Jan
                                                            2021</a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-footer">
                                                    <div
                                                        ...
                                                        <a href="#" class=""><i
                                                                class="las la-user mr-2 font-size-20"></i>Only You</a>
                                                        <a href="#" class=""><i
                                                                class="las la-calendar mr-2 font-size-20"></i>5 Jan
                                                            2021</a>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <ul class="list-inline p-0 m-0">
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="{{url('images/user/01.jpg')}}"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="{{url('images/user/02.jpg')}}"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <li>
                                <div class="media align-items-center cust-card">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="{{url('images/user/03.jpg')}}"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="content create-workform mb-4">
                        <ul class="row mb-0 p-0 list-inline flex-wrap align-items-center">
                            <li class="col-md-4 mb-4">
                                <a href="#">
                                    <img src="{{url('images/gallery/grid/01.jpg')}}"
                                        class="img-fluid rounded avatar-150" alt="">
                                </a>
                            </li>
                            <li class="col-md-4 mb-4">
                                <a href="#">
                            ...
                            <li class="col-md-4">
                                <a href="#">
                                    <img src="{{url('images/gallery/grid/04.jpg')}}"
                                        class="img-fluid rounded avatar-150" alt="">
                                </a>
                            </li>
                            <li class="col-md-4">
                            ...
                            <li class="col-md-4">
                                <a href="#">
                                    <img src="{{url('images/gallery/grid/06.jpg')}}"
                                        class="img-fluid rounded avatar-150" alt="">
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="content create-workform">
                        ...
                        <ul class="list-inline p-0 m-0">
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="{{url('images/user/04.jpg')}}"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="{{url('images/user/05.jpg')}}"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="content create-workform">
                        ...
                        <ul class="list-inline p-0 m-0">
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="{{url('images/user/06.jpg')}}"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="{{url('images/user/07.jpg')}}"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="{{url('images/user/08.jpg')}}"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <li>
                                <div class="media align-items-center cust-card mb-3">
                                    <div class="">
                                        <img class="avatar-50 rounded-small" src="{{url('images/user/09.jpg')}}"
                                            alt="01">
                                    </div>
                                    <div class="media-body ml-3">
                                        <div class="d-flex align-items-center justify-content-between">

          ...
          <div class="sidebar-caption dropdown">
              ...
              <div class="dropdown-menu w-100 border-0 my-2" aria-labelledby="dropdownMenuButton">
                  ...
                  <a class="dropdown-item mb-2" href="{{ route('user.profile-edit') }}">
                      <i class="las la-user-edit font-size-20 mr-1"></i>
                      <span>Edit Profile</span>
                  </a>
                  <a class="dropdown-item mb-2" href="{{ route('user.account-setting') }}">
                      <i class="las la-user-cog font-size-20 mr-1"></i>
                      <span>Account Settings</span>
                  </a>
                  <a class="dropdown-item mb-3" href="{{ route('user.privacy-setting') }}">
          ...
          <div class="data-scrollbar" data-scroll="1">
              ...
              <div class="sidebar-btn dropdown mb-3">
                  ...
                  <div class="dropdown-menu w-100 border-0 py-3" aria-labelledby="dropdownMenuButton01">
                      <a class="dropdown-item mb-2" href="{{ route('create.new-note1') }}">
                          <span><i class="ri-sticky-note-line mr-3"></i>Blank Notes</span>
                      </a>
                      <a class="dropdown-item mb-2" href="{{ route('create.new-note3') }}">
                          <span><i class="ri-todo-line mr-3"></i>To-do</span>
                      </a>
                      <a class="dropdown-item mb-2" href="{{ route('create.new-note4') }}">
                          <span><i class="ri-booklet-line mr-3"></i>Essay Notes</span>
                      </a>
                      <a class="dropdown-item" href="{{ route('create.new-note2') }}">
                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                      ...
                      <li class="">
                          ...
                          <ul id="notebooks" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="">
                                  <a href="{{ route('page.project-plans') }}" class="svg-icon">
                                      <i>
                              ...
                              <li class="">
                                  <a href="{{ route('page.routine-notes') }}" class="svg-icon">
                                      <i>
                              ...
                              <li class="">
                                  <a href="{{ route('page.planning') }}" class="svg-icon">
                                      <i>
                      ...
                      <li class="">
                          <a href="{{ route('page.reminder') }}" class="svg-icon">
                              <i>
                      ...
                      <li class="">
                          <a href="{{ route('page.bin') }}" class="svg-icon">
                              <i>
                          ...
                          <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="">
                                  ...
                                  <ul id="user" class="iq-submenu collapse" data-parent="#otherpage">
                                      ...
                                      <li class="">
                                          <a href="{{ route('user.add') }}" class="svg-icon">
                                              <i class="">
                                      ...
                                      <li class="">
                                          <a href="{{ route('user.list') }}" class="svg-icon">
                                              <i class="">
                              ...
                              <li class="">
                                  ...
                                  <ul id="auth" class="iq-submenu collapse" data-parent="#otherpage">
                                      <li class="">
                                          <a href="{{ route('auth.sign-in') }}" class="svg-icon">
                                              <i class="">
                                      ...
                                      <li class="">
                                          <a href="{{ route('auth.sign-up') }}" class="svg-icon">
                                              <i class="">
                                      ...
                                      <li class="">
                                          <a href="{{ route('auth.confirm-mail') }}" class="svg-icon">
                                              <i class="">
                              ...
                              <li class="">
                                  ...
                                  <ul id="pages-error" class="iq-submenu collapse" data-parent="#otherpage">
                                      ...
                                      <li class="">
                                          <a href="{{ route('error.500') }}" class="svg-icon">
                                              <i class="">
                              ...
                              <li class="">
                                  <a href="{{ route('error.maintenance') }}" class="svg-icon">
                                      <i class="">
